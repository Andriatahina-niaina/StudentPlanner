 ...
 */
final class Version20241111142712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etablishment (id INT AUTO_INCREMENT NOT NULL, district_etab_id INT NOT NULL, statu_juridique VARCHAR(255) NOT NULL, presco_nombres INT NOT NULL, primaire_nombres INT NOT NULL, college_nombres INT NOT NULL, lycee_nombres INT NOT NULL, anne_scolaire VARCHAR(255) NOT NULL, INDEX IDX_5FB71052C4F57281 (district_etab_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE personal (id INT AUTO_INCREMENT NOT NULL, district_person_id INT NOT NULL, status VARCHAR(255) NOT NULL, person_nbr_presco INT NOT NULL, person_nbr_primaire INT NOT NULL, person_nbr_college INT NOT NULL, person_nbr_lycee INT NOT NULL, anne_scolaire VARCHAR(255) NOT NULL, INDEX IDX_F18A6D84FF98F117 (district_person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
