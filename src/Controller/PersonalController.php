...
{
    #[Route('/home/personal/{annee?}', name: 'app_personal', defaults: ['annee' => '2016-2017'])]
    public function index(Request $request, PersonalRepository $repository, string $annee): Response
    {
        // Préparer les données pour les cartes
        $personals = $repository->findBy(['anne_scolaire' => $annee]);
    ...
    #[Route('/home/personal/chart-data', name: 'app_personal_chart_data', methods: ['GET'])]
    public function getChartData(Request $request, PersonalRepository $repository): JsonResponse
    {
